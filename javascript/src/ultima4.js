...
ultima4.gameData = (function() {
  ...
  return {
    ...
    font: font,
    townMaps: rleDecode(atob(townMaps)),
...
ultima4.main = (function() {
  ...
  function getTownTileAt(x, y, town) {
    return (x>=0 && x<32 && y>=0 && y<32) ?
      townMaps.charCodeAt(y*32+x) : tileType.grass;
  }
